...
opacity_255 = 180  # 20% of 255 = 51
opacity = opacity_255 / 255.0  # convert to 0.0–1.0 for Image.blend

# Automatically find directory the script is in
...
for file_name in input_files:
    ...
    for color_name, hex_color in colors:
        ...
        # Multiply base RGB with overlay color (simulate full opacity)
        multiplied_rgb = ImageChops.multiply(base_rgb, overlay_rgb)

        # Blend result with base RGB at desired opacity
